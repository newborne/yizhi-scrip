  ...
  renderPage2() {
    ...
    return (
      <View style={{flex: 1}}>
        ...
        <View
          style={{backgroundColor: '#fff', padding: 10, overflow: 'hidden'}}>
          <View
            style={{
              backgroundColor: '#eee',
              flexGrow: 1,
...
class MyTouchableOpacity extends TouchableOpacity {
  constructor(props) {
    ...
    let touchableHandleStartShouldSetResponder =
      this.touchableHandleStartShouldSetResponder;
    let touchableHandleResponderTerminationRequest =
