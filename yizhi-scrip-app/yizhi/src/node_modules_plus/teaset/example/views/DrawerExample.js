        ...
        <ListRow
          icon={
            <View style={{paddingRight: 12}}>
              <Image
                style={{width: 30, height: 30, tintColor: Theme.primaryColor}}
          ...
          title="User name"
        />
        <ListRow icon={require('../icons/home_active.png')} title="Home" />
        <ListRow
