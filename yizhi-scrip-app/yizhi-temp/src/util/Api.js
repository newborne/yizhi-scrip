...
export const USERS_RECOMMEND_USER_LIST = 'yizhi-server/api/v1/users/recommendUserList';
...
export const USERS_FOLLOW_FRIENDID = 'yizhi-server/api/v1/users/follow/:friendId';
export const USERS_UNFOLLOW_FRIENDID = 'yizhi-server/api/v1/users/unfollow/:friendId';
export const USERS_QUERY_USER_INFO = 'yizhi-server/api/v1/users/queryUserInfo/:userId';
export const USERS_FOLLOW_COUNTS = 'yizhi-server/api/v1/users/follow/counts';
export const USERS_FOLLOW_LIST_TYPE = 'yizhi-server/api/v1/users/follow/list/:type';
export const USERS_UPDATE_USER_INFO = 'yizhi-server/api/v1/users/updateUserInfo';
// post
...
export const COMMENT_ID_DISLIKE = 'yizhi-server/api/v1/comment/comment/:id/dislike';
// message
...
export const ARTICLE_ID_DISLIKE = 'yizhi-server/api/v1/comment/article/:id/dislike';
// material
...
export const MATERIAL_ID_UNLOVE = 'yizhi-server/api/v1/comment/material/:id/unlove';
